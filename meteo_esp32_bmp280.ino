      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("</style></head><body><h1>ESP32 with BMP280 Home</h1>");
            ...
            client.println("<tr><td>Pressure hPa</td><td><span class=\"sensor\">");
            client.println(bmp.readPressure() / 100.0F);
            client.println(" hPa</span></td></tr>");
            client.println("<tr><td>Pressure mm Hg</td><td><span class=\"sensor\">");
            client.println((bmp.readPressure() / 100.0F) / 1.333);
